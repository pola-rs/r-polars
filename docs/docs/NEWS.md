...
- 'Backend' improvements
  - (prepare support for aarch64-linux) Touch libgcc\_eh.a by @yutannihilation in #49
  ...
  - DO NOT MERGE: tracking hello\_r\_universe branch by @eitsupi in #38
...
- Customize **extendr** to better support cross Rust-R/R-Rust error handling
  - bump extendr\_api by @sorhawell in #44
...
- All string Expressions available
  ...
  - rust\_result tests + fixes by @sorhawell in #41
...
- Expr arr list functions + rework r\_to\_series by @sorhawell in #2
