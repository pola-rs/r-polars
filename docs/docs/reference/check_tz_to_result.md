...
<span class='r-in'><span><span class='va'>check_tz_to_result</span> <span class='op'>=</span> <span class='fu'>polars</span><span class='fu'>:::</span><span class='va'><a href='https://rdrr.io/pkg/polars/man/check_tz_to_result.html'>check_tz_to_result</a></span> <span class='co'># expose internal</span></span></span>
