...
<span class='r-out co'><span class='r-pr'>#&gt;</span>  [1] "as_data_frame"  "clone"          "columns"        "drop"           "drop_in_place"  "drop_nulls"     "dtype_strings"  "dtypes"        </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span>  [9] "estimated_size" "fill_nan"       "fill_null"      "filter"         "first"          "frame_equal"    "get_column"     "get_columns"   </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [17] "groupby"        "height"         "join"           "last"           "lazy"           "limit"          "max"            "mean"          </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [25] "median"         "min"            "null_count"     "print"          "quantile"       "reverse"        "schema"         "select"        </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [33] "shape"          "shift"          "shift_and_fill" "slice"          "sort"           "std"            "sum"            "tail"          </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [41] "to_data_frame"  "to_list"        "to_series"      "to_struct"      "unique"         "unnest"         "var"            "width"         </span>
...
<span class='r-out co'><span class='r-pr'>#&gt;</span>  [1] "by_agg"                    "clone_see_me_macro"        "columns"                   "drop_in_place"            </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span>  [5] "dtype_strings"             "dtypes"                    "estimated_size"            "export_stream"            </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span>  [9] "frame_equal"               "from_arrow_record_batches" "get_column"                "get_columns"              </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [13] "lazy"                      "new"                       "new_par_from_list"         "new_with_capacity"        </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [17] "null_count"                "print"                     "schema"                    "select"                   </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [21] "select_at_idx"             "set_column_from_robj"      "set_column_from_series"    "set_column_names_mut"     </span>
<span class='r-out co'><span class='r-pr'>#&gt;</span> [25] "shape"                     "to_list"                   "to_list_tag_structs"       "to_list_unwind"           </span>
