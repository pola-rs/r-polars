...
SEXP savvy_PlRSeries_to_r_vector__ffi(SEXP self__, SEXP c_arg__int64, SEXP c_arg__struct_, SEXP c_arg__as_clock_class, SEXP c_arg__ambiguous, SEXP c_arg__non_existent, SEXP c_arg__local_time_zone);
