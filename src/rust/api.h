...
SEXP savvy_PlRLazyFrame_sink_json__ffi(SEXP self__, SEXP c_arg__target, SEXP c_arg__sync_on_close, SEXP c_arg__maintain_order, SEXP c_arg__mkdir, SEXP c_arg__storage_options);
