...
SEXP savvy_PlRLazyFrame_sink_ndjson__ffi(SEXP self__, SEXP c_arg__target, SEXP c_arg__retries, SEXP c_arg__sync_on_close, SEXP c_arg__maintain_order, SEXP c_arg__mkdir, SEXP c_arg__compression, SEXP c_arg__check_extension, SEXP c_arg__compression_level, SEXP c_arg__storage_options);
