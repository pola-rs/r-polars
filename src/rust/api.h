...
SEXP savvy_as_list__ffi(SEXP c_arg__s);
...
SEXP savvy_concat_df_horizontal__ffi(SEXP c_arg__dfs, SEXP c_arg__strict);
...
SEXP savvy_concat_lf_horizontal__ffi(SEXP c_arg__lfs, SEXP c_arg__parallel, SEXP c_arg__strict);
...
SEXP savvy_drain_warnings__ffi(void);
...
SEXP savvy_lit_from_series__ffi(SEXP c_arg__value, SEXP c_arg__keep_series, SEXP c_arg__keep_name);
...
SEXP savvy_PlRDataFrame_hash_rows__ffi(SEXP self__, SEXP c_arg__seed);
...
SEXP savvy_PlRExpr_arr_dot__ffi(SEXP self__, SEXP c_arg__other);
...
SEXP savvy_PlRExpr_arr_to_struct__ffi(SEXP self__, SEXP c_arg__fields);
...
SEXP savvy_PlRExpr_dt_total_days__ffi(SEXP self__, SEXP c_arg__fractional);
SEXP savvy_PlRExpr_dt_total_hours__ffi(SEXP self__, SEXP c_arg__fractional);
SEXP savvy_PlRExpr_dt_total_microseconds__ffi(SEXP self__, SEXP c_arg__fractional);
SEXP savvy_PlRExpr_dt_total_milliseconds__ffi(SEXP self__, SEXP c_arg__fractional);
SEXP savvy_PlRExpr_dt_total_minutes__ffi(SEXP self__, SEXP c_arg__fractional);
SEXP savvy_PlRExpr_dt_total_nanoseconds__ffi(SEXP self__, SEXP c_arg__fractional);
SEXP savvy_PlRExpr_dt_total_seconds__ffi(SEXP self__, SEXP c_arg__fractional);
...
SEXP savvy_PlRExpr_explode__ffi(SEXP self__, SEXP c_arg__empty_as_null, SEXP c_arg__keep_nulls);
...
SEXP savvy_PlRExpr_gather__ffi(SEXP self__, SEXP c_arg__idx, SEXP c_arg__null_on_oob);
...
SEXP savvy_PlRExpr_hash__ffi(SEXP self__, SEXP c_arg__seed);
...
SEXP savvy_PlRExpr_list_to_struct__ffi(SEXP self__, SEXP c_arg__names);
...
SEXP savvy_PlRExpr_map_batches__ffi(SEXP self__, SEXP c_arg__lambda, SEXP c_arg__is_elementwise, SEXP c_arg__returns_scalar, SEXP c_arg__output_type);
SEXP savvy_PlRExpr_max__ffi(SEXP self__);
SEXP savvy_PlRExpr_max_by__ffi(SEXP self__, SEXP c_arg__by);
...
SEXP savvy_PlRExpr_min_by__ffi(SEXP self__, SEXP c_arg__by);
SEXP savvy_PlRExpr_mode__ffi(SEXP self__, SEXP c_arg__maintain_order);
...
SEXP savvy_PlRExpr_rolling_rank__ffi(SEXP self__, SEXP c_arg__window_size, SEXP c_arg__method, SEXP c_arg__center, SEXP c_arg__seed, SEXP c_arg__min_samples);
SEXP savvy_PlRExpr_rolling_rank_by__ffi(SEXP self__, SEXP c_arg__by, SEXP c_arg__window_size, SEXP c_arg__method, SEXP c_arg__min_samples, SEXP c_arg__closed, SEXP c_arg__seed);
...
SEXP savvy_PlRExpr_str_extract_many__ffi(SEXP self__, SEXP c_arg__patterns, SEXP c_arg__ascii_case_insensitive, SEXP c_arg__overlapping, SEXP c_arg__leftmost);
SEXP savvy_PlRExpr_str_find__ffi(SEXP self__, SEXP c_arg__pat, SEXP c_arg__literal, SEXP c_arg__strict);
SEXP savvy_PlRExpr_str_find_many__ffi(SEXP self__, SEXP c_arg__patterns, SEXP c_arg__ascii_case_insensitive, SEXP c_arg__overlapping, SEXP c_arg__leftmost);
...
SEXP savvy_PlRExpr_str_json_decode__ffi(SEXP self__, SEXP c_arg__dtype);
...
SEXP savvy_PlRExpr_str_to_decimal__ffi(SEXP self__, SEXP c_arg__scale);
...
SEXP savvy_PlRExpr_struct_drop__ffi(SEXP self__, SEXP c_arg__names, SEXP c_arg__strict);
...
SEXP savvy_PlRLazyFrame_explode__ffi(SEXP self__, SEXP c_arg__subset, SEXP c_arg__empty_as_null, SEXP c_arg__keep_nulls);
...
SEXP savvy_PlRLazyFrame_join_where__ffi(SEXP self__, SEXP c_arg__other, SEXP c_arg__predicates, SEXP c_arg__how, SEXP c_arg__suffix);
...
SEXP savvy_PlRLazyFrame_sink_batches__ffi(SEXP self__, SEXP c_arg__lambda, SEXP c_arg__maintain_order, SEXP c_arg__chunk_size);
...
SEXP savvy_PlRLazyFrame_sink_ipc__ffi(SEXP self__, SEXP c_arg__target, SEXP c_arg__compression, SEXP c_arg__compat_level, SEXP c_arg__sync_on_close, SEXP c_arg__maintain_order, SEXP c_arg__mkdir, SEXP c_arg__storage_options);
SEXP savvy_PlRLazyFrame_sink_ndjson__ffi(SEXP self__, SEXP c_arg__target, SEXP c_arg__compression, SEXP c_arg__check_extension, SEXP c_arg__sync_on_close, SEXP c_arg__maintain_order, SEXP c_arg__mkdir, SEXP c_arg__compression_level, SEXP c_arg__storage_options);
...
SEXP savvy_PlRLazyFrame_to_arrow_c_stream__ffi(SEXP self__, SEXP c_arg__stream_ptr, SEXP c_arg__polars_compat_level, SEXP c_arg__engine, SEXP c_arg__maintain_order, SEXP c_arg__chunk_size);
...
SEXP savvy_PlRSelector_by_name__ffi(SEXP c_arg__names, SEXP c_arg__require_all, SEXP c_arg__expand_patterns);
...
SEXP savvy_PlRSeries_is_include_binary__ffi(SEXP self__);
SEXP savvy_PlRSeries_is_include_list__ffi(SEXP self__);
SEXP savvy_PlRSeries_is_include_null__ffi(SEXP self__);
SEXP savvy_PlRSeries_is_include_time__ffi(SEXP self__);
...
SEXP savvy_PlRSeries_list_to_struct__ffi(SEXP self__, SEXP c_arg__fields);
