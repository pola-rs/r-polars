...
SEXP savvy_field__ffi(SEXP names);
...
SEXP savvy_PlRExpr_struct_with_fields__ffi(SEXP self__, SEXP fields);
...
SEXP savvy_PlRLazyFrame_sort_by_exprs__ffi(SEXP self__, SEXP by, SEXP descending, SEXP nulls_last, SEXP maintain_order, SEXP multithreaded);
SEXP savvy_PlRLazyFrame_with_columns__ffi(SEXP self__, SEXP exprs);
...
SEXP savvy_PlRSeries_new_from_clock_time_point__ffi(SEXP name, SEXP left, SEXP right, SEXP multiplier, SEXP time_unit);
SEXP savvy_PlRSeries_to_r_vector__ffi(SEXP self__, SEXP int64, SEXP as_clock_class, SEXP ambiguous, SEXP non_existent, SEXP local_time_zone);
