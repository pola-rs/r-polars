...
impl RPolarsSeries {
    ...
    pub fn to_r(&self, bigint_conversion: &str) -> std::result::Result<Robj, String> {
        pl_series_to_list(&self.0, true, bigint_conversion)
