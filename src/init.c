...
SEXP savvy_PlRSeries_to_r_vector__impl(SEXP self__, SEXP c_arg__int64, SEXP c_arg__struct, SEXP c_arg__as_clock_class, SEXP c_arg__ambiguous, SEXP c_arg__non_existent, SEXP c_arg__local_time_zone) {
    SEXP res = savvy_PlRSeries_to_r_vector__ffi(self__, c_arg__int64, c_arg__struct, c_arg__as_clock_class, c_arg__ambiguous, c_arg__non_existent, c_arg__local_time_zone);
    return handle_result(res);
}
