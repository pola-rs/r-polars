...
different languages can be called rust-polars, py-polars, r-polars, nodejs-polars ...
...
that the **polars** syntax and expressions are (deliberately) as close to the
...
Let's load the **polars** package and get our feet wet with a tongue-in-cheek
...
The key point of this example is the following: All **polars** constructors can
...
_Method chaining_ is a core part of the **polars** workflow. If you're coming
...
have been converted to an appropriate **polars** class.] Later on, we'll see
...
(As an aside, notice that **polars** DataFrames have their own "pretty" print
method.)
