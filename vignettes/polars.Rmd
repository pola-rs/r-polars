...
([`$filter()`](https://pola-rs.github.io/r-polars/man/DataFrame_filter.html))
and also columns
([`$select()`](https://pola-rs.github.io/r-polars/man/DataFrame_select.html)):
...
[`$with_columns()`](https://pola-rs.github.io/r-polars/man/DataFrame_with_columns.html)
...
[`$agg()`](https://pola-rs.github.io/r-polars/man/Expr_agg_groups.html) methods.
...
[reference manual](https://pola-rs.github.io/r-polars/man/DataFrame_join.html).
...
"[LazyFrame](https://pola-rs.github.io/r-polars/man/LazyFrame_class.html)" from an
