...
- Features for CRAN compatibility
  - `disable_auto_limit_max_threads`, this feature disables the automatic limit of the maximum number of threads to 2 for CRAN compatibility,
    and the maximum number of threads is used by default.
    In other words, if this feature is enabled, it is not compatible with CRAN.
