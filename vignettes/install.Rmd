...
- If the pre-built Rust library binary is not available, the Rust library will be built from source.

### From GitHub releases

Binary pacages for the Amd64 architecture are available.
