...
While it is possible to create a `Series` of type `Struct` in Python via
`pl.Series()`, this is not possible in R:
...
Instead, one should use the method `$to_struct()` to convert existing columns
