test_that("meta$eq meta$neq", {
  ...
  expect_error(e2$meta$neq(complex(1)), "in \\$meta\\$neq")
})
...
test_that("meta$root_names", {
  ...
  expect_equal(e$meta$root_names(), "alice")
  expect_identical(
...
test_that("meta$output_name", {
  e <- pl$col("alice")$alias("bob")
  expect_equal(e$meta$output_name(), "bob")
  expect_identical(
  ...
  expect_error(
    ...
    "\\$meta\\$output_name | Cannot determine an output column"
  )
})

test_that("meta$undo_aliases", {
  e <- pl$col("alice")$alias("bob")
  expect_equal(e$meta$undo_aliases()$meta$output_name(), "alice")
})
