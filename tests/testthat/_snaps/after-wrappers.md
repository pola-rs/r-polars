# public and private functions in pl and .pr
    ...
    Output
       ...
       [35] "arg_where"                 "class_names"              
       [37] "coalesce"                  "col"                      
       [39] "concat"                    "concat_list"              
       [41] "concat_str"                "corr"                     
       [43] "count"                     "cov"                      
       [45] "date"                      "date_range"               
       [47] "datetime"                  "datetime_range"           
       [49] "disable_string_cache"      "dtypes"                   
       [51] "duration"                  "element"                  
       [53] "enable_string_cache"       "first"                    
       [55] "fold"                      "from_epoch"               
       [57] "get_global_rpool_cap"      "head"                     
       [59] "implode"                   "is_schema"                
       [61] "last"                      "len"                      
       [63] "lit"                       "max"                      
       [65] "max_horizontal"            "mean"                     
       [67] "median"                    "mem_address"              
       [69] "min"                       "min_horizontal"           
       [71] "n_unique"                  "numeric_dtypes"           
       [73] "raw_list"                  "read_csv"                 
       [75] "read_ndjson"               "read_parquet"             
       [77] "reduce"                    "rolling_corr"             
       [79] "rolling_cov"               "same_outer_dt"            
       [81] "scan_csv"                  "scan_ipc"                 
       [83] "scan_ndjson"               "scan_parquet"             
       [85] "select"                    "set_global_rpool_cap"     
       [87] "show_all_public_functions" "show_all_public_methods"  
       [89] "std"                       "struct"                   
       [91] "sum"                       "sum_horizontal"           
       [93] "tail"                      "thread_pool_size"         
       [95] "threadpool_size"           "time"                     
       [97] "using_string_cache"        "var"                      
       [99] "when"                      "with_string_cache"        
