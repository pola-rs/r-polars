...
# public and private methods of each class Expr
    ...
    Output
       ...
       [88] "limit"             "list"              "lit"              
       [91] "lit_to_df"         "lit_to_s"          "log"              
       [94] "log10"             "lower_bound"       "lt"               
       [97] "lt_eq"             "map"               "map_batches"      
      [100] "map_elements"      "max"               "mean"             
      [103] "median"            "meta"              "min"              
      [106] "mod"               "mode"              "mul"              
      [109] "n_unique"          "name"              "nan_max"          
      [112] "nan_min"           "neq"               "neq_missing"      
      [115] "not"               "null_count"        "or"               
      [118] "over"              "pct_change"        "peak_max"         
      [121] "peak_min"          "pow"               "print"            
      [124] "product"           "quantile"          "rank"             
      [127] "rechunk"           "reinterpret"       "rep"              
      [130] "rep_extend"        "repeat_by"         "reshape"          
      [133] "reverse"           "rolling"           "rolling_max"      
