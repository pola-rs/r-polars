...
# public and private methods of each class Expr
    ...
    Output
      ...
      [154] "set_sorted"          "shift"               "shift_and_fill"     
...
---
    ...
    Output
      ...
      [265] "shift_and_fill"             "shrink_dtype"              
      [267] "shuffle"                    "sign"                      
      [269] "sin"                        "sinh"                      
      [271] "skew"                       "slice"                     
      [273] "sort_by"                    "sort_with"                 
      [275] "std"                        "str_base64_decode"         
      [277] "str_base64_encode"          "str_concat"                
      ...
      [289] "str_hex_encode"             "str_json_decode"           
...
# public and private methods of each class RPolarsSeries
    ...
    Output
      ...
      [163] "shift_and_fill"      "shrink_dtype"        "shuffle"            
      [166] "sign"                "sin"                 "sinh"               
      [169] "skew"                "slice"               "sort"               
      [172] "sort_by"             "sqrt"                "std"                
      [175] "str"                 "struct"              "sub"                
      [178] "sum"                 "tail"                "tan"                
      [181] "tanh"                "to_frame"            "to_list"            
      [184] "to_lit"              "to_physical"         "to_r"               
