# public and private functions in pl and .pr
    ...
    Output
       ...
       [63] "is_schema"                 "last"                     
       [65] "len"                       "lit"                      
       [67] "max"                       "max_horizontal"           
       [69] "mean"                      "mean_horizontal"          
       [71] "median"                    "mem_address"              
       [73] "min"                       "min_horizontal"           
       [75] "n_unique"                  "numeric_dtypes"           
       [77] "raw_list"                  "read_csv"                 
       [79] "read_ndjson"               "read_parquet"             
       [81] "reduce"                    "rolling_corr"             
       [83] "rolling_cov"               "same_outer_dt"            
       [85] "scan_csv"                  "scan_ipc"                 
       [87] "scan_ndjson"               "scan_parquet"             
       [89] "select"                    "set_global_rpool_cap"     
       [91] "show_all_public_functions" "show_all_public_methods"  
       [93] "std"                       "struct"                   
