...
---
    ...
    Output
      ...
      [115] "is_between"                 "is_duplicated"             
      [117] "is_finite"                  "is_first_distinct"         
      [119] "is_in"                      "is_infinite"               
      [121] "is_last_distinct"           "is_nan"                    
      [123] "is_not_nan"                 "is_not_null"               
      [125] "is_null"                    "is_unique"                 
      [127] "kurtosis"                   "last"                      
      [129] "len"                        "list_all"                  
      [131] "list_any"                   "list_arg_max"              
      [133] "list_arg_min"               "list_contains"             
      [135] "list_diff"                  "list_eval"                 
      [137] "list_gather"                "list_get"                  
      [139] "list_join"                  "list_len"                  
      [141] "list_max"                   "list_mean"                 
      [143] "list_min"                   "list_reverse"              
      [145] "list_set_operation"         "list_shift"                
      [147] "list_slice"                 "list_sort"                 
      [149] "list_sum"                   "list_to_struct"            
      [151] "list_unique"                "lit"                       
      [153] "log"                        "log10"                     
      [155] "lower_bound"                "lt"                        
      [157] "lt_eq"                      "map_batches"               
      [159] "map_batches_in_background"  "map_elements_in_background"
      [161] "max"                        "mean"                      
      [163] "median"                     "meta_eq"                   
      [165] "meta_has_multiple_outputs"  "meta_is_regex_projection"  
      [167] "meta_output_name"           "meta_pop"                  
      [169] "meta_roots"                 "meta_tree_format"          
      [171] "meta_undo_aliases"          "min"                       
      [173] "mode"                       "mul"                       
      [175] "n_unique"                   "name_keep"                 
      [177] "name_map"                   "name_prefix"               
      [179] "name_suffix"                "name_to_lowercase"         
      [181] "name_to_uppercase"          "nan_max"                   
      [183] "nan_min"                    "neq"                       
      [185] "neq_missing"                "new_first"                 
      [187] "new_last"                   "new_len"                   
      [189] "not"                        "null_count"                
      [191] "or"                         "over"                      
      [193] "pct_change"                 "peak_max"                  
      [195] "peak_min"                   "pow"                       
      [197] "print"                      "product"                   
      [199] "quantile"                   "rank"                      
      [201] "rechunk"                    "reinterpret"               
      [203] "rem"                        "rep"                       
      [205] "repeat_by"                  "replace"                   
      [207] "reshape"                    "reverse"                   
      [209] "rle"                        "rle_id"                    
      [211] "rolling"                    "rolling_corr"              
      [213] "rolling_cov"                "rolling_max"               
      [215] "rolling_mean"               "rolling_median"            
      [217] "rolling_min"                "rolling_quantile"          
      [219] "rolling_skew"               "rolling_std"               
      [221] "rolling_sum"                "rolling_var"               
      [223] "round"                      "sample_frac"               
      [225] "sample_n"                   "search_sorted"             
      [227] "shift"                      "shift_and_fill"            
      [229] "shrink_dtype"               "shuffle"                   
      [231] "sign"                       "sin"                       
      [233] "sinh"                       "skew"                      
      [235] "slice"                      "sort"                      
      [237] "sort_by"                    "std"                       
      [239] "str_base64_decode"          "str_base64_encode"         
      [241] "str_concat"                 "str_contains"              
      [243] "str_contains_any"           "str_count_matches"         
      [245] "str_ends_with"              "str_explode"               
      [247] "str_extract"                "str_extract_all"           
      [249] "str_hex_decode"             "str_hex_encode"            
      [251] "str_json_decode"            "str_json_path_match"       
      [253] "str_len_bytes"              "str_len_chars"             
      [255] "str_pad_end"                "str_pad_start"             
      [257] "str_parse_int"              "str_replace"               
      [259] "str_replace_all"            "str_replace_many"          
      [261] "str_reverse"                "str_slice"                 
      [263] "str_split"                  "str_split_exact"           
      [265] "str_splitn"                 "str_starts_with"           
      [267] "str_strip_chars"            "str_strip_chars_end"       
      [269] "str_strip_chars_start"      "str_to_date"               
      [271] "str_to_datetime"            "str_to_lowercase"          
      [273] "str_to_time"                "str_to_titlecase"          
      [275] "str_to_uppercase"           "str_zfill"                 
      [277] "struct_field_by_name"       "struct_rename_fields"      
      [279] "sub"                        "sum"                       
      [281] "tail"                       "tan"                       
      [283] "tanh"                       "timestamp"                 
      [285] "to_physical"                "top_k"                     
      [287] "unique"                     "unique_counts"             
      [289] "unique_stable"              "upper_bound"               
      [291] "value_counts"               "var"                       
      [293] "xor"                       
