...
# public and private methods of each class Expr
    ...
    Output
      ...
      [157] "shift"               "shrink_dtype"        "shuffle"            
      [160] "sign"                "sin"                 "sinh"               
      [163] "skew"                "slice"               "sort"               
...
---
    ...
    Output
      ...
      [171] "list_sample_frac"           "list_sample_n"             
      [173] "list_set_operation"         "list_shift"                
      [175] "list_slice"                 "list_sort"                 
      [177] "list_sum"                   "list_to_struct"            
      [179] "list_unique"                "lit"                       
      [181] "log"                        "log10"                     
      [183] "lower_bound"                "lt"                        
      [185] "lt_eq"                      "map_batches"               
      [187] "map_batches_in_background"  "map_elements_in_background"
      [189] "max"                        "mean"                      
      [191] "median"                     "meta_eq"                   
      [193] "meta_has_multiple_outputs"  "meta_is_regex_projection"  
      [195] "meta_output_name"           "meta_pop"                  
      [197] "meta_root_names"            "meta_tree_format"          
      [199] "meta_undo_aliases"          "min"                       
      [201] "mode"                       "mul"                       
      [203] "n_unique"                   "name_keep"                 
      [205] "name_map"                   "name_prefix"               
      [207] "name_prefix_fields"         "name_suffix"               
      [209] "name_suffix_fields"         "name_to_lowercase"         
      [211] "name_to_uppercase"          "nan_max"                   
      [213] "nan_min"                    "neq"                       
      [215] "neq_missing"                "new_first"                 
      [217] "new_last"                   "new_len"                   
      [219] "not"                        "null_count"                
      [221] "or"                         "over"                      
      [223] "pct_change"                 "peak_max"                  
      [225] "peak_min"                   "pow"                       
      [227] "print"                      "product"                   
      [229] "qcut"                       "qcut_uniform"              
      [231] "quantile"                   "rank"                      
      [233] "rechunk"                    "reinterpret"               
      [235] "rem"                        "rep"                       
      [237] "repeat_by"                  "replace"                   
      [239] "replace_strict"             "reshape"                   
      [241] "reverse"                    "rle"                       
      [243] "rle_id"                     "rolling"                   
      [245] "rolling_corr"               "rolling_cov"               
      [247] "rolling_max"                "rolling_max_by"            
      [249] "rolling_mean"               "rolling_mean_by"           
      [251] "rolling_median"             "rolling_median_by"         
      [253] "rolling_min"                "rolling_min_by"            
      [255] "rolling_quantile"           "rolling_quantile_by"       
      [257] "rolling_skew"               "rolling_std"               
      [259] "rolling_std_by"             "rolling_sum"               
      [261] "rolling_sum_by"             "rolling_var"               
      [263] "rolling_var_by"             "round"                     
      [265] "sample_frac"                "sample_n"                  
      [267] "search_sorted"              "shift"                     
      [269] "shrink_dtype"               "shuffle"                   
      [271] "sign"                       "sin"                       
      [273] "sinh"                       "skew"                      
      [275] "slice"                      "sort_by"                   
      [277] "sort_with"                  "std"                       
      [279] "str_base64_decode"          "str_base64_encode"         
      [281] "str_contains"               "str_contains_any"          
      [283] "str_count_matches"          "str_ends_with"             
      [285] "str_extract"                "str_extract_all"           
      [287] "str_extract_groups"         "str_extract_many"          
      [289] "str_find"                   "str_head"                  
      [291] "str_hex_decode"             "str_hex_encode"            
      [293] "str_join"                   "str_json_decode"           
      [295] "str_json_path_match"        "str_len_bytes"             
      [297] "str_len_chars"              "str_pad_end"               
      [299] "str_pad_start"              "str_replace"               
      [301] "str_replace_all"            "str_replace_many"          
      [303] "str_reverse"                "str_slice"                 
      [305] "str_split"                  "str_split_exact"           
      [307] "str_splitn"                 "str_starts_with"           
      [309] "str_strip_chars"            "str_strip_chars_end"       
      [311] "str_strip_chars_start"      "str_tail"                  
      [313] "str_to_date"                "str_to_datetime"           
      [315] "str_to_integer"             "str_to_lowercase"          
      [317] "str_to_time"                "str_to_titlecase"          
      [319] "str_to_uppercase"           "str_zfill"                 
      [321] "struct_field_by_name"       "struct_rename_fields"      
      [323] "struct_with_fields"         "sub"                       
      [325] "sum"                        "tail"                      
      [327] "tan"                        "tanh"                      
      [329] "to_physical"                "top_k"                     
      [331] "unique"                     "unique_counts"             
      [333] "unique_stable"              "upper_bound"               
      [335] "value_counts"               "var"                       
      [337] "xor"                       
...
# public and private methods of each class Then
    ...
    Output
      ...
      [157] "set_sorted"          "shift"               "shrink_dtype"       
