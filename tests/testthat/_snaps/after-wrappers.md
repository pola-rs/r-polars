# public and private functions in pl and .pr
    ...
    Code
      ls(pl)
    Output
       [1] "Binary"               "Boolean"              "Categorical"         
       [4] "DataFrame"            "Date"                 "Datetime"            
       [7] "Field"                "Float32"              "Float64"             
      [10] "Int16"                "Int32"                "Int64"               
      [13] "Int8"                 "LazyFrame"            "List"                
      [16] "Null"                 "PTime"                "SQLContext"          
      [19] "Series"               "Struct"               "Time"                
      [22] "UInt16"               "UInt32"               "UInt64"              
      [25] "UInt8"                "Unknown"              "Utf8"                
      [28] "all"                  "all_horizontal"       "any_horizontal"      
      [31] "approx_n_unique"      "class_names"          "coalesce"            
      [34] "col"                  "concat"               "concat_list"         
      [37] "concat_str"           "corr"                 "count"               
      [40] "cov"                  "date_range"           "disable_string_cache"
      [43] "dtypes"               "element"              "enable_string_cache" 
      [46] "expr_to_r"            "first"                "fold"                
      [49] "from_arrow"           "get_global_rpool_cap" "head"                
      [52] "implode"              "last"                 "lit"                 
      [55] "max"                  "max_horizontal"       "mean"                
      [58] "median"               "mem_address"          "min"                 
      [61] "min_horizontal"       "n_unique"             "numeric_dtypes"      
      [64] "options"              "polars_info"          "pub_class_env"       
      [67] "pub_env"              "raw_list"             "read_csv"            
      [70] "read_ndjson"          "read_parquet"         "reduce"              
      [73] "reset_options"        "rolling_corr"         "rolling_cov"         
      [76] "same_outer_dt"        "scan_csv"             "scan_ipc"            
      [79] "scan_ndjson"          "scan_parquet"         "select"              
      [82] "set_global_rpool_cap" "set_options"          "std"                 
      [85] "struct"               "sum"                  "sum_horizontal"      
      [88] "tail"                 "using_string_cache"   "var"                 
      [91] "when"                 "with_string_cache"   
...
---
    ...
    Output
      ...
      [237] "str_count_matches"          "str_ends_with"             
      [239] "str_explode"                "str_extract"               
      [241] "str_extract_all"            "str_hex_decode"            
      [243] "str_hex_encode"             "str_json_decode"           
      [245] "str_json_path_match"        "str_len_bytes"             
      [247] "str_len_chars"              "str_pad_end"               
      [249] "str_pad_start"              "str_parse_int"             
      [251] "str_replace"                "str_replace_all"           
      [253] "str_slice"                  "str_split"                 
      [255] "str_split_exact"            "str_splitn"                
      [257] "str_starts_with"            "str_strip_chars"           
      [259] "str_strip_chars_end"        "str_strip_chars_start"     
      [261] "str_to_date"                "str_to_datetime"           
      [263] "str_to_lowercase"           "str_to_time"               
      [265] "str_to_titlecase"           "str_to_uppercase"          
      [267] "str_zfill"                  "struct_field_by_name"      
      [269] "struct_rename_fields"       "sub"                       
      [271] "sum"                        "tail"                      
      [273] "tan"                        "tanh"                      
      [275] "timestamp"                  "to_physical"               
      [277] "top_k"                      "unique"                    
      [279] "unique_counts"              "unique_stable"             
      [281] "upper_bound"                "value_counts"              
      [283] "var"                        "xor"                       
