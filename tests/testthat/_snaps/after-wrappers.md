...
---
    ...
    Output
      ...
      [157] "list_gather"                "list_get"                  
      [159] "list_join"                  "list_len"                  
      [161] "list_max"                   "list_mean"                 
      [163] "list_min"                   "list_reverse"              
      [165] "list_set_operation"         "list_shift"                
      [167] "list_slice"                 "list_sort"                 
      [169] "list_sum"                   "list_to_struct"            
      [171] "list_unique"                "lit"                       
      [173] "log"                        "log10"                     
      [175] "lower_bound"                "lt"                        
      [177] "lt_eq"                      "map_batches"               
      [179] "map_batches_in_background"  "map_elements_in_background"
      [181] "max"                        "mean"                      
      [183] "median"                     "meta_eq"                   
      [185] "meta_has_multiple_outputs"  "meta_is_regex_projection"  
      [187] "meta_output_name"           "meta_pop"                  
      [189] "meta_roots"                 "meta_tree_format"          
      [191] "meta_undo_aliases"          "min"                       
      [193] "mode"                       "mul"                       
      [195] "n_unique"                   "name_keep"                 
      [197] "name_map"                   "name_prefix"               
      [199] "name_suffix"                "name_to_lowercase"         
      [201] "name_to_uppercase"          "nan_max"                   
      [203] "nan_min"                    "neq"                       
      [205] "neq_missing"                "new_first"                 
      [207] "new_last"                   "new_len"                   
      [209] "not"                        "null_count"                
      [211] "or"                         "over"                      
      [213] "pct_change"                 "peak_max"                  
      [215] "peak_min"                   "pow"                       
      [217] "print"                      "product"                   
      [219] "quantile"                   "rank"                      
      [221] "rechunk"                    "reinterpret"               
      [223] "rem"                        "rep"                       
      [225] "repeat_by"                  "replace"                   
      [227] "reshape"                    "reverse"                   
      [229] "rle"                        "rle_id"                    
      [231] "rolling"                    "rolling_corr"              
      [233] "rolling_cov"                "rolling_max"               
      [235] "rolling_mean"               "rolling_median"            
      [237] "rolling_min"                "rolling_quantile"          
      [239] "rolling_skew"               "rolling_std"               
      [241] "rolling_sum"                "rolling_var"               
      [243] "round"                      "sample_frac"               
      [245] "sample_n"                   "search_sorted"             
      [247] "shift"                      "shift_and_fill"            
      [249] "shrink_dtype"               "shuffle"                   
      [251] "sign"                       "sin"                       
      [253] "sinh"                       "skew"                      
      [255] "slice"                      "sort"                      
      [257] "sort_by"                    "std"                       
      [259] "str_base64_decode"          "str_base64_encode"         
      [261] "str_concat"                 "str_contains"              
      [263] "str_contains_any"           "str_count_matches"         
      [265] "str_ends_with"              "str_explode"               
      [267] "str_extract"                "str_extract_all"           
      [269] "str_hex_decode"             "str_hex_encode"            
      [271] "str_json_decode"            "str_json_path_match"       
      [273] "str_len_bytes"              "str_len_chars"             
      [275] "str_pad_end"                "str_pad_start"             
      [277] "str_parse_int"              "str_replace"               
      [279] "str_replace_all"            "str_replace_many"          
      [281] "str_reverse"                "str_slice"                 
      [283] "str_split"                  "str_split_exact"           
      [285] "str_splitn"                 "str_starts_with"           
      [287] "str_strip_chars"            "str_strip_chars_end"       
      [289] "str_strip_chars_start"      "str_to_date"               
      [291] "str_to_datetime"            "str_to_lowercase"          
      [293] "str_to_time"                "str_to_titlecase"          
      [295] "str_to_uppercase"           "str_zfill"                 
      [297] "struct_field_by_name"       "struct_rename_fields"      
      [299] "sub"                        "sum"                       
      [301] "tail"                       "tan"                       
      [303] "tanh"                       "timestamp"                 
      [305] "to_physical"                "top_k"                     
      [307] "unique"                     "unique_counts"             
      [309] "unique_stable"              "upper_bound"               
      [311] "value_counts"               "var"                       
      [313] "xor"                       
...
# public and private methods of each class RPolarsSeries
    ...
    Output
      ...
      [130] "reinterpret"       "rem"               "rename"           
      [133] "rep"               "rep_extend"        "repeat_by"        
      [136] "replace"           "reshape"           "reverse"          
      [139] "rle"               "rle_id"            "rolling"          
      [142] "rolling_max"       "rolling_mean"      "rolling_median"   
      [145] "rolling_min"       "rolling_quantile"  "rolling_skew"     
      [148] "rolling_std"       "rolling_sum"       "rolling_var"      
      [151] "round"             "sample"            "search_sorted"    
      [154] "set_sorted"        "shape"             "shift"            
      ...
      [169] "str"               "struct"            "sub"              
      [172] "sum"               "tail"              "tan"              
      [175] "tanh"              "to_frame"          "to_lit"           
      [178] "to_physical"       "to_r"              "to_r_list"        
      [181] "to_r_vector"       "to_struct"         "to_vector"        
      [184] "top_k"             "unique"            "unique_counts"    
      [187] "upper_bound"       "value_counts"      "var"              
      [190] "xor"              
