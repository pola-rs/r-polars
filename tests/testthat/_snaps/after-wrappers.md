# public and private functions in pl and .pr
    ...
    Output
       ...
       [67] "mean_horizontal"           "median"                   
       [69] "mem_address"               "min"                      
       [71] "min_horizontal"            "n_unique"                 
       [73] "numeric_dtypes"            "raw_list"                 
       [75] "read_csv"                  "read_ndjson"              
       [77] "read_parquet"              "reduce"                   
       [79] "rolling_corr"              "rolling_cov"              
       [81] "same_outer_dt"             "scan_csv"                 
       [83] "scan_ipc"                  "scan_ndjson"              
       [85] "scan_parquet"              "select"                   
       [87] "set_global_rpool_cap"      "show_all_public_functions"
       [89] "show_all_public_methods"   "std"                      
       [91] "struct"                    "sum"                      
       [93] "sum_horizontal"            "tail"                     
       [95] "thread_pool_size"          "threadpool_size"          
       [97] "time"                      "using_string_cache"       
       [99] "var"                       "when"                     
      [101] "with_string_cache"        
