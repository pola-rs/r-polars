# public and private functions in pl and .pr
    ...
    Output
       ...
       [43] "corr"                      "count"                    
       [45] "cov"                       "date"                     
       [47] "date_range"                "datetime"                 
       [49] "datetime_range"            "disable_string_cache"     
       [51] "dtypes"                    "duration"                 
       [53] "element"                   "enable_string_cache"      
       [55] "first"                     "fold"                     
       [57] "from_epoch"                "get_global_rpool_cap"     
       [59] "head"                      "implode"                  
       [61] "is_schema"                 "last"                     
       [63] "len"                       "lit"                      
       [65] "max"                       "max_horizontal"           
       [67] "mean"                      "mean_horizontal"          
       [69] "median"                    "mem_address"              
       [71] "min"                       "min_horizontal"           
       [73] "n_unique"                  "numeric_dtypes"           
       [75] "raw_list"                  "read_csv"                 
       [77] "read_ndjson"               "read_parquet"             
       [79] "reduce"                    "rolling_corr"             
       [81] "rolling_cov"               "same_outer_dt"            
       [83] "scan_csv"                  "scan_ipc"                 
       [85] "scan_ndjson"               "scan_parquet"             
       [87] "select"                    "set_global_rpool_cap"     
       [89] "show_all_public_functions" "show_all_public_methods"  
       [91] "std"                       "struct"                   
       [93] "sum"                       "sum_horizontal"           
       [95] "tail"                      "thread_pool_size"         
       [97] "threadpool_size"           "time"                     
       [99] "using_string_cache"        "var"                      
      [101] "when"                      "with_string_cache"        
