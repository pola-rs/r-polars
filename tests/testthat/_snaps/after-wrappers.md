...
# public and private methods of each class RPolarsSeries
    ...
    Output
       ...
       [58] "explode"           "expr"              "extend_constant"  
       [61] "fill_nan"          "fill_null"         "filter"           
       [64] "first"             "flags"             "flatten"          
       [67] "floor"             "floor_div"         "forward_fill"     
       [70] "gather"            "gather_every"      "gt"               
       [73] "gt_eq"             "hash"              "head"             
       [76] "implode"           "inspect"           "interpolate"      
       [79] "is_between"        "is_duplicated"     "is_finite"        
       [82] "is_first_distinct" "is_in"             "is_infinite"      
       [85] "is_last_distinct"  "is_nan"            "is_not_nan"       
       [88] "is_not_null"       "is_null"           "is_numeric"       
       [91] "is_sorted"         "is_unique"         "kurtosis"         
       [94] "last"              "len"               "limit"            
       [97] "list"              "lit"               "log"              
      [100] "log10"             "lower_bound"       "lt"               
      [103] "lt_eq"             "map_batches"       "map_elements"     
      [106] "max"               "mean"              "median"           
      [109] "meta"              "min"               "mod"              
      [112] "mode"              "mul"               "n_unique"         
      [115] "name"              "nan_max"           "nan_min"          
      [118] "neq"               "neq_missing"       "not"              
      [121] "null_count"        "or"                "over"             
      [124] "pct_change"        "peak_max"          "peak_min"         
      [127] "pow"               "print"             "product"          
      [130] "quantile"          "rank"              "rechunk"          
      [133] "reinterpret"       "rem"               "rename"           
      [136] "rep"               "rep_extend"        "repeat_by"        
      [139] "replace"           "reshape"           "reverse"          
      [142] "rle"               "rle_id"            "rolling"          
      [145] "rolling_max"       "rolling_mean"      "rolling_median"   
      [148] "rolling_min"       "rolling_quantile"  "rolling_skew"     
      [151] "rolling_std"       "rolling_sum"       "rolling_var"      
