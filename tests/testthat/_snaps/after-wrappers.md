...
# public and private methods of each class RPolarsSeries
    ...
    Output
      ...
      [106] "mean"              "median"            "meta"             
      [109] "min"               "mod"               "mode"             
      [112] "mul"               "n_unique"          "name"             
      [115] "nan_max"           "nan_min"           "neq"              
      [118] "neq_missing"       "not"               "null_count"       
      [121] "or"                "over"              "pct_change"       
      [124] "peak_max"          "peak_min"          "pow"              
      [127] "print"             "product"           "quantile"         
      [130] "rank"              "rechunk"           "reinterpret"      
      [133] "rem"               "rename"            "rep"              
      [136] "rep_extend"        "repeat_by"         "replace"          
      [139] "reshape"           "reverse"           "rle"              
      [142] "rle_id"            "rolling"           "rolling_max"      
      [145] "rolling_mean"      "rolling_median"    "rolling_min"      
      [148] "rolling_quantile"  "rolling_skew"      "rolling_std"      
      [151] "rolling_sum"       "rolling_var"       "round"            
      [154] "sample"            "search_sorted"     "set_sorted"       
      [157] "shape"             "shift"             "shift_and_fill"   
      ...
      [172] "struct"            "sub"               "sum"              
      [175] "tail"              "tan"               "tanh"             
      [178] "to_frame"          "to_lit"            "to_physical"      
      [181] "to_r"              "to_r_list"         "to_r_vector"      
      [184] "to_struct"         "to_vector"         "top_k"            
