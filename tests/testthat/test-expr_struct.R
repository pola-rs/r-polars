test_that("expr struct$field", {
  ...
  expect_error(unwrap(err_state), "is not a single string")
  expect_error(unwrap(err_state), "\\[name\\]")
  expect_error(unwrap(err_state), "in struct\\$field:")
  expect_error(unwrap(err_state), "42.0")
})
...
test_that("expr struct$rename_fields", {
  ...
  expect_error(unwrap(err_state), "is not a single string")
  expect_error(unwrap(err_state), "\\[names\\]")
  expect_error(unwrap(err_state), "in struct\\$rename_fields:")
  expect_error(unwrap(err_state), "42.0")
})
