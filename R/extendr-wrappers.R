...
PolarsLazyFrame <- new.env(parent = emptyenv())

PolarsLazyFrame$print <- function() .Call(wrap__PolarsLazyFrame__print, self)

PolarsLazyFrame$describe_plan <- function() invisible(.Call(wrap__PolarsLazyFrame__describe_plan, self))

PolarsLazyFrame$debug_plan <- function() .Call(wrap__PolarsLazyFrame__debug_plan, self)

PolarsLazyFrame$describe_optimized_plan <- function() .Call(wrap__PolarsLazyFrame__describe_optimized_plan, self)

PolarsLazyFrame$collect_background <- function() .Call(wrap__PolarsLazyFrame__collect_background, self)

PolarsLazyFrame$collect <- function() .Call(wrap__PolarsLazyFrame__collect, self)

PolarsLazyFrame$collect_handled <- function() .Call(wrap__PolarsLazyFrame__collect_handled, self)

PolarsLazyFrame$first <- function() .Call(wrap__PolarsLazyFrame__first, self)

PolarsLazyFrame$last <- function() .Call(wrap__PolarsLazyFrame__last, self)

PolarsLazyFrame$max <- function() .Call(wrap__PolarsLazyFrame__max, self)

PolarsLazyFrame$min <- function() .Call(wrap__PolarsLazyFrame__min, self)

PolarsLazyFrame$mean <- function() .Call(wrap__PolarsLazyFrame__mean, self)

PolarsLazyFrame$median <- function() .Call(wrap__PolarsLazyFrame__median, self)

PolarsLazyFrame$sum <- function() .Call(wrap__PolarsLazyFrame__sum, self)

PolarsLazyFrame$std <- function(ddof) .Call(wrap__PolarsLazyFrame__std, self, ddof)

PolarsLazyFrame$var <- function(ddof) .Call(wrap__PolarsLazyFrame__var, self, ddof)

PolarsLazyFrame$quantile <- function(quantile, interpolation) .Call(wrap__PolarsLazyFrame__quantile, self, quantile, interpolation)

PolarsLazyFrame$shift <- function(periods) .Call(wrap__PolarsLazyFrame__shift, self, periods)

PolarsLazyFrame$shift_and_fill <- function(fill_value, periods) .Call(wrap__PolarsLazyFrame__shift_and_fill, self, fill_value, periods)

PolarsLazyFrame$reverse <- function() .Call(wrap__PolarsLazyFrame__reverse, self)

PolarsLazyFrame$drop <- function(columns) .Call(wrap__PolarsLazyFrame__drop, self, columns)

PolarsLazyFrame$fill_nan <- function(fill_value) .Call(wrap__PolarsLazyFrame__fill_nan, self, fill_value)

PolarsLazyFrame$fill_null <- function(fill_value) .Call(wrap__PolarsLazyFrame__fill_null, self, fill_value)

PolarsLazyFrame$slice <- function(offset, length) .Call(wrap__PolarsLazyFrame__slice, self, offset, length)

PolarsLazyFrame$select <- function(exprs) .Call(wrap__PolarsLazyFrame__select, self, exprs)

PolarsLazyFrame$limit <- function(n) .Call(wrap__PolarsLazyFrame__limit, self, n)

PolarsLazyFrame$tail <- function(n) .Call(wrap__PolarsLazyFrame__tail, self, n)

PolarsLazyFrame$filter <- function(expr) .Call(wrap__PolarsLazyFrame__filter, self, expr)

PolarsLazyFrame$drop_nulls <- function(subset) .Call(wrap__PolarsLazyFrame__drop_nulls, self, subset)

PolarsLazyFrame$unique <- function(subset, keep, maintain_order) .Call(wrap__PolarsLazyFrame__unique, self, subset, keep, maintain_order)

PolarsLazyFrame$groupby <- function(exprs, maintain_order) .Call(wrap__PolarsLazyFrame__groupby, self, exprs, maintain_order)

PolarsLazyFrame$with_columns <- function(exprs) .Call(wrap__PolarsLazyFrame__with_columns, self, exprs)

PolarsLazyFrame$with_column <- function(expr) .Call(wrap__PolarsLazyFrame__with_column, self, expr)

PolarsLazyFrame$join_asof <- function(other, left_on, right_on, left_by, right_by, allow_parallel, force_parallel, suffix, strategy, tolerance, tolerance_str) .Call(wrap__PolarsLazyFrame__join_asof, self, other, left_on, right_on, left_by, right_by, allow_parallel, force_parallel, suffix, strategy, tolerance, tolerance_str)

PolarsLazyFrame$join <- function(other, left_on, right_on, how, suffix, allow_parallel, force_parallel) .Call(wrap__PolarsLazyFrame__join, self, other, left_on, right_on, how, suffix, allow_parallel, force_parallel)

PolarsLazyFrame$sort_by_exprs <- function(by, descending, nulls_last) .Call(wrap__PolarsLazyFrame__sort_by_exprs, self, by, descending, nulls_last)

PolarsLazyFrame$melt <- function(id_vars, value_vars, value_name, variable_name, streamable) .Call(wrap__PolarsLazyFrame__melt, self, id_vars, value_vars, value_name, variable_name, streamable)

PolarsLazyFrame$rename <- function(existing, new) .Call(wrap__PolarsLazyFrame__rename, self, existing, new)

#' @export
`$.PolarsLazyFrame` <- function (self, name) { func <- PolarsLazyFrame[[name]]; environment(func) <- environment(); func }

#' @export
`[[.PolarsLazyFrame` <- `$.PolarsLazyFrame`
