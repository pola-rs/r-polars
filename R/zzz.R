...
.onLoad <- function(libname, pkgname) {
  ...
  s3_register("nanoarrow::as_nanoarrow_array_stream", "polars_lazy_frame")
  s3_register("nanoarrow::as_nanoarrow_array_stream", "polars_series")
  s3_register("reticulate::r_to_py", "polars_data_frame")
  s3_register("reticulate::r_to_py", "polars_lazy_frame")
  s3_register("reticulate::r_to_py", "polars_series")
