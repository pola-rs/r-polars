...
`PlRSeries_to_r_vector` <- function(self) {
  function(`int64`, `struct`, `as_clock_class`, `ambiguous`, `non_existent`, `local_time_zone`) {
    `ambiguous` <- .savvy_extract_ptr(`ambiguous`, "PlRExpr")
    .Call(savvy_PlRSeries_to_r_vector__impl, `self`, `int64`, `struct`, `as_clock_class`, `ambiguous`, `non_existent`, `local_time_zone`)
  }
}
