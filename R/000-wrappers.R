...
`PlRExpr_arr_len` <- function(self) {
  function() {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_arr_len__impl, `self`))
  }
}
...
`PlRExpr_ewm_mean` <- function(self) {
  function(`alpha`, `adjust`, `min_samples`, `ignore_nulls`) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_ewm_mean__impl, `self`, `alpha`, `adjust`, `min_samples`, `ignore_nulls`))
  }
}
...
`PlRExpr_ewm_std` <- function(self) {
  function(`alpha`, `adjust`, `bias`, `min_samples`, `ignore_nulls`) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_ewm_std__impl, `self`, `alpha`, `adjust`, `bias`, `min_samples`, `ignore_nulls`))
  }
}

`PlRExpr_ewm_var` <- function(self) {
  function(`alpha`, `adjust`, `bias`, `min_samples`, `ignore_nulls`) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_ewm_var__impl, `self`, `alpha`, `adjust`, `bias`, `min_samples`, `ignore_nulls`))
  }
}
...
`PlRExpr_rolling_mean` <- function(self) {
  function(`window_size`, `center`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_mean__impl, `self`, `window_size`, `center`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_rolling_median` <- function(self) {
  function(`window_size`, `center`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_median__impl, `self`, `window_size`, `center`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_rolling_min` <- function(self) {
  function(`window_size`, `center`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_min__impl, `self`, `window_size`, `center`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_rolling_quantile` <- function(self) {
  function(`quantile`, `interpolation`, `window_size`, `center`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_quantile__impl, `self`, `quantile`, `interpolation`, `window_size`, `center`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_rolling_std` <- function(self) {
  function(`window_size`, `center`, `ddof`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_std__impl, `self`, `window_size`, `center`, `ddof`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_rolling_sum` <- function(self) {
  function(`window_size`, `center`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_sum__impl, `self`, `window_size`, `center`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_rolling_var` <- function(self) {
  function(`window_size`, `center`, `ddof`, `weights` = NULL, `min_samples` = NULL) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_rolling_var__impl, `self`, `window_size`, `center`, `ddof`, `weights`, `min_samples`))
  }
}
...
`PlRExpr_str_to_decimal` <- function(self) {
  function(`scale`) {
    .savvy_wrap_PlRExpr(.Call(savvy_PlRExpr_str_to_decimal__impl, `self`, `scale`))
  }
}
...
`PlRLazyFrame_sink_ipc` <- function(self) {
  function(`target`, `compression`, `compat_level`, `retries`, `sync_on_close`, `maintain_order`, `mkdir`, `storage_options` = NULL) {
    .savvy_wrap_PlRLazyFrame(.Call(savvy_PlRLazyFrame_sink_ipc__impl, `self`, `target`, `compression`, `compat_level`, `retries`, `sync_on_close`, `maintain_order`, `mkdir`, `storage_options`))
  }
}
...
`PlRLazyFrame_sink_parquet` <- function(self) {
  function(`target`, `compression`, `stat_min`, `stat_max`, `stat_distinct_count`, `stat_null_count`, `retries`, `sync_on_close`, `maintain_order`, `mkdir`, `compression_level` = NULL, `row_group_size` = NULL, `data_page_size` = NULL, `storage_options` = NULL) {
    .savvy_wrap_PlRLazyFrame(.Call(savvy_PlRLazyFrame_sink_parquet__impl, `self`, `target`, `compression`, `stat_min`, `stat_max`, `stat_distinct_count`, `stat_null_count`, `retries`, `sync_on_close`, `maintain_order`, `mkdir`, `compression_level`, `row_group_size`, `data_page_size`, `storage_options`))
  }
}
...
`PlROptFlags_copy` <- function(self) {
  function() {
    .savvy_wrap_PlROptFlags(.Call(savvy_PlROptFlags_copy__impl, `self`))
  }
}

`PlROptFlags_get_check_order_observe` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_check_order_observe__impl, `self`)
  }
}

`PlROptFlags_get_cluster_with_columns` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_cluster_with_columns__impl, `self`)
  }
}

`PlROptFlags_get_comm_subexpr_elim` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_comm_subexpr_elim__impl, `self`)
  }
}

`PlROptFlags_get_comm_subplan_elim` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_comm_subplan_elim__impl, `self`)
  }
}

`PlROptFlags_get_eager` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_eager__impl, `self`)
  }
}

`PlROptFlags_get_fast_projection` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_fast_projection__impl, `self`)
  }
}

`PlROptFlags_get_predicate_pushdown` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_predicate_pushdown__impl, `self`)
  }
}

`PlROptFlags_get_projection_pushdown` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_projection_pushdown__impl, `self`)
  }
}

`PlROptFlags_get_simplify_expression` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_simplify_expression__impl, `self`)
  }
}

`PlROptFlags_get_slice_pushdown` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_slice_pushdown__impl, `self`)
  }
}

`PlROptFlags_get_streaming` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_streaming__impl, `self`)
  }
}

`PlROptFlags_get_type_check` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_type_check__impl, `self`)
  }
}

`PlROptFlags_get_type_coercion` <- function(self) {
  function() {
    .Call(savvy_PlROptFlags_get_type_coercion__impl, `self`)
  }
}

`PlROptFlags_set_check_order_observe` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_check_order_observe__impl, `self`, `value`))
  }
}

`PlROptFlags_set_cluster_with_columns` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_cluster_with_columns__impl, `self`, `value`))
  }
}

`PlROptFlags_set_comm_subexpr_elim` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_comm_subexpr_elim__impl, `self`, `value`))
  }
}

`PlROptFlags_set_comm_subplan_elim` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_comm_subplan_elim__impl, `self`, `value`))
  }
}

`PlROptFlags_set_eager` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_eager__impl, `self`, `value`))
  }
}

`PlROptFlags_set_fast_projection` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_fast_projection__impl, `self`, `value`))
  }
}

`PlROptFlags_set_predicate_pushdown` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_predicate_pushdown__impl, `self`, `value`))
  }
}

`PlROptFlags_set_projection_pushdown` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_projection_pushdown__impl, `self`, `value`))
  }
}

`PlROptFlags_set_simplify_expression` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_simplify_expression__impl, `self`, `value`))
  }
}

`PlROptFlags_set_slice_pushdown` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_slice_pushdown__impl, `self`, `value`))
  }
}

`PlROptFlags_set_streaming` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_streaming__impl, `self`, `value`))
  }
}

`PlROptFlags_set_type_check` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_type_check__impl, `self`, `value`))
  }
}

`PlROptFlags_set_type_coercion` <- function(self) {
  function(`value`) {
    invisible(.Call(savvy_PlROptFlags_set_type_coercion__impl, `self`, `value`))
  }
}
...
`.savvy_wrap_PlROptFlags` <- function(ptr) {
  e <- new.env(parent = emptyenv())
  e$.ptr <- ptr
  e$`copy` <- `PlROptFlags_copy`(ptr)
  e$`get_check_order_observe` <- `PlROptFlags_get_check_order_observe`(ptr)
  e$`get_cluster_with_columns` <- `PlROptFlags_get_cluster_with_columns`(ptr)
  e$`get_comm_subexpr_elim` <- `PlROptFlags_get_comm_subexpr_elim`(ptr)
  e$`get_comm_subplan_elim` <- `PlROptFlags_get_comm_subplan_elim`(ptr)
  e$`get_eager` <- `PlROptFlags_get_eager`(ptr)
  e$`get_fast_projection` <- `PlROptFlags_get_fast_projection`(ptr)
  e$`get_predicate_pushdown` <- `PlROptFlags_get_predicate_pushdown`(ptr)
  e$`get_projection_pushdown` <- `PlROptFlags_get_projection_pushdown`(ptr)
  e$`get_simplify_expression` <- `PlROptFlags_get_simplify_expression`(ptr)
  e$`get_slice_pushdown` <- `PlROptFlags_get_slice_pushdown`(ptr)
  e$`get_streaming` <- `PlROptFlags_get_streaming`(ptr)
  e$`get_type_check` <- `PlROptFlags_get_type_check`(ptr)
  e$`get_type_coercion` <- `PlROptFlags_get_type_coercion`(ptr)
  e$`set_check_order_observe` <- `PlROptFlags_set_check_order_observe`(ptr)
  e$`set_cluster_with_columns` <- `PlROptFlags_set_cluster_with_columns`(ptr)
  e$`set_comm_subexpr_elim` <- `PlROptFlags_set_comm_subexpr_elim`(ptr)
  e$`set_comm_subplan_elim` <- `PlROptFlags_set_comm_subplan_elim`(ptr)
  e$`set_eager` <- `PlROptFlags_set_eager`(ptr)
  e$`set_fast_projection` <- `PlROptFlags_set_fast_projection`(ptr)
  e$`set_predicate_pushdown` <- `PlROptFlags_set_predicate_pushdown`(ptr)
  e$`set_projection_pushdown` <- `PlROptFlags_set_projection_pushdown`(ptr)
  e$`set_simplify_expression` <- `PlROptFlags_set_simplify_expression`(ptr)
  e$`set_slice_pushdown` <- `PlROptFlags_set_slice_pushdown`(ptr)
  e$`set_streaming` <- `PlROptFlags_set_streaming`(ptr)
  e$`set_type_check` <- `PlROptFlags_set_type_check`(ptr)
  e$`set_type_coercion` <- `PlROptFlags_set_type_coercion`(ptr)
...
`PlROptFlags`$`default` <- function() {
  .savvy_wrap_PlROptFlags(.Call(savvy_PlROptFlags_default__impl))
}

`PlROptFlags`$`empty` <- function() {
  .savvy_wrap_PlROptFlags(.Call(savvy_PlROptFlags_empty__impl))
}
...
`PlRSelector_hash` <- function(self) {
  function() {
    .Call(savvy_PlRSelector_hash__impl, `self`)
  }
}
...
`.savvy_wrap_PlRSelector` <- function(ptr) {
  e <- new.env(parent = emptyenv())
  e$.ptr <- ptr
  e$`difference` <- `PlRSelector_difference`(ptr)
  e$`exclusive_or` <- `PlRSelector_exclusive_or`(ptr)
  e$`hash` <- `PlRSelector_hash`(ptr)
...
`PlRSelector` <- new.env(parent = emptyenv())

### associated functions for PlRSelector

`PlRSelector`$`all` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_all__impl))
}
...
`PlRSelector`$`by_dtype` <- function(`dtypes`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_by_dtype__impl, `dtypes`))
}

`PlRSelector`$`by_index` <- function(`indices`, `require_all`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_by_index__impl, `indices`, `require_all`))
}
...
`PlRSelector`$`categorical` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_categorical__impl))
}

`PlRSelector`$`datetime` <- function(`time_unit`, `time_zone`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_datetime__impl, `time_unit`, `time_zone`))
}

`PlRSelector`$`decimal` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_decimal__impl))
}

`PlRSelector`$`duration` <- function(`time_unit`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_duration__impl, `time_unit`))
}

`PlRSelector`$`empty` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_empty__impl))
}

`PlRSelector`$`first` <- function(`strict`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_first__impl, `strict`))
}

`PlRSelector`$`float` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_float__impl))
}

`PlRSelector`$`integer` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_integer__impl))
}

`PlRSelector`$`last` <- function(`strict`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_last__impl, `strict`))
}
...
`PlRSelector`$`matches` <- function(`pattern`) {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_matches__impl, `pattern`))
}

`PlRSelector`$`nested` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_nested__impl))
}

`PlRSelector`$`numeric` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_numeric__impl))
}

`PlRSelector`$`enum` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_enum__impl))
}

`PlRSelector`$`struct` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_struct__impl))
}

`PlRSelector`$`signed_integer` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_signed_integer__impl))
}

`PlRSelector`$`temporal` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_temporal__impl))
}

`PlRSelector`$`unsigned_integer` <- function() {
  .savvy_wrap_PlRSelector(.Call(savvy_PlRSelector_unsigned_integer__impl))
}
...
`PlRSeries_is_include_binary` <- function(self) {
  function() {
    .Call(savvy_PlRSeries_is_include_binary__impl, `self`)
  }
}

`PlRSeries_is_include_list` <- function(self) {
  function() {
    .Call(savvy_PlRSeries_is_include_list__impl, `self`)
  }
}

`PlRSeries_is_include_null` <- function(self) {
  function() {
    .Call(savvy_PlRSeries_is_include_null__impl, `self`)
  }
}

`PlRSeries_is_include_time` <- function(self) {
  function() {
    .Call(savvy_PlRSeries_is_include_time__impl, `self`)
  }
}
...
`PlRSeries_shrink_dtype` <- function(self) {
  function() {
    .savvy_wrap_PlRSeries(.Call(savvy_PlRSeries_shrink_dtype__impl, `self`))
  }
}
...
`.savvy_wrap_PlRSeries` <- function(ptr) {
  ...
  e$`is_include_binary` <- `PlRSeries_is_include_binary`(ptr)
  e$`is_include_list` <- `PlRSeries_is_include_list`(ptr)
  e$`is_include_null` <- `PlRSeries_is_include_null`(ptr)
  e$`is_include_time` <- `PlRSeries_is_include_time`(ptr)
