...
**Update:** As of March 2023, **rpolars** has now reached nearly
100% coverage of the underlying "lazy" Expr syntax. While translation of the
"eager" syntax is still a little further behind, you should be able to do just
about everything using `$select()` + `$with_columns()`.
