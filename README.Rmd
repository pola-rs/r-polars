...
[![Docs stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://rpolars.github.io)
...
**Update:** As of March 2023, **polars** has now reached nearly
...
Binary builds are also available for users running the latest release of R (4.2
at the time of writing) on Ubuntu 22.04 LTS ("Jammy Jellyfish").  Please see the
GitHub release section below for binary install options on other Linux distros.
...
The introductory vignette (`vignette("polars")`) contains a series of detailed
examples. But here is a quick illustration of **polars** in action.
