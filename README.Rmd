...
If experiencing unexpected sluggish performance, when using polars in a given IDE, we like to here about it. You can try to activate `pl$set_polars_options(debug_polars = TRUE)` to profile what methods are being touched (not necessarily run) and how fast. Below is printed an example of good behavior.
