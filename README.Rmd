...
- Install [`rustup`](https://rustup.rs/), the cross-platform Rust installer. Then:
  ...
  ```
- Windows: Make sure the latest version of [Rtools](https://cran.r-project.org/bin/windows/Rtools/) is installed and on your PATH. Add gnu target e.g. `rustup target add x86_64-pc-windows-gnu`
