...
To avoid conflicts with other packages and base R function names, many of `polars`'s
...
Version 0 of this package was previously maintained by [Søren Havelund Welling](https://github.com/sorhawell).
